...
export default class setPassword extends Component {
  ...
  savePasswordAndRedirectToLogin(e) {
    e.preventDefault();
    return http
      .put(`${CONSTANTS.API_URL}/api/admin/user/${this.state.userID}/setpassword`,
        {
              ...
              <div class="column"> { /* comment end*/ }
                ...
                <div class="row">
                  <div class="column auth-form">
                    ...
                    <div class="field">
                      <input value={this.password} name="confirmNewPassword" id="confirmNewPassword"
